...
@Widgetset("com.mycompany.vaadin.app.gwt.vaadinAppWidgetSet")
@Theme("touchkit")
...
@PreserveOnRefresh
public class vaadinAppTouchKitUI extends UI {

    private final vaadinAppPersistToServerRpc serverRpc = new vaadinAppPersistToServerRpc() {
        @Override
